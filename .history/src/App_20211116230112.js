...
const App = () => {
  ...
  const getSnapshot=(event)=>{
    ...
    FileSaver.saveAs(mid,"image.png");
  }
  return (
    <React.Fragment>
      <p className="input-class style">Enter the title of the photo to search. The title of the images are in between 0 to 5 inclusive</p>
